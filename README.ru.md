...
- **Vault** — всегда включённое шифрование (Argon2id + XChaCha20-Poly1305) для ключей,
  паролей, identities и сертификатов; биометрическая разблокировка на Android. Удалённые
  хосты, ключи, сниппеты и туннели 30 дней лежат в корзине и восстанавливаются — на любом
...
- **Раннбуки** — сохранённые процедуры, которые выполняются в живой сессии по шагам: шаг может
  ждать вашего подтверждения, а ненулевой код возврата останавливает прогон, а не идёт дальше.
