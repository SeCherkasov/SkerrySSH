...
> **iOS ОТЛОЖЕН (2026-06-21):** iOS исключён из проекта, активны Desktop + Android. Разделы про
> iOS Keychain / Secure Enclave / LAContext ниже сохранены как re-entry план на будущее, но
> сейчас НЕ реализуются. Актуальная платформенная часть — только Android (Keystore + BiometricPrompt).
