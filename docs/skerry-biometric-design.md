...
Статус: **черновик на одобрение**. Код пока не написан намеренно — это security-критичный,
завязанный на реальные устройства флоу; реализация после одобрения архитектуры и на устройстве.
