...
object SecretRedactor {
    ...
    // Незакавыченное значение берём до конца строки (`[^\r\n]*\S`), а НЕ одним токеном `\S+`: иначе
    // многословный секрет (`secret = my long passphrase`) или двухсловный `Authorization: Basic <base64>`
    // маскировал бы лишь первое слово, а остаток утекал в облако.
