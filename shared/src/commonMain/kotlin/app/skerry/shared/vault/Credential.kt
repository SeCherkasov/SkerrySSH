...
/**
 * Запись keychain — переиспользуемый секрет (ключ/пароль/сертификат). На неё ссылаются учётки
 * ([Identity.credentialId]), а не хосты напрямую: один секрет может обслуживать несколько учёток.
