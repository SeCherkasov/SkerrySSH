 ...
 * bottom of the buffer, and the run ends by itself when the session does.
 */
fun runbookTarget(sessionId: String, terminal: TerminalScreenState): RunbookTarget = RunbookTarget(
    sessionId = sessionId,
