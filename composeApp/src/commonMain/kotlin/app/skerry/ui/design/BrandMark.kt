 ...
 * концентрические дуги-волны, открытые вправо (убывающая прозрачность). Перенос SVG из
 * `docs/new/Skerry.html` (viewBox 0 0 120 120) на Canvas; координаты масштабируются `u = size/120`.
 */
@Composable
