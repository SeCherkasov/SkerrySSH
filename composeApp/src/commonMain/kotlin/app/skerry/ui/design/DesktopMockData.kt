...
/**
 * Статичные данные макета `docs/new/Skerry.html` (порт литералов из `renderVals()`): rail,
 * группы хостов, навигация настроек, AI-политики. Это демонстрационное наполнение прототипа —
 * живой каталог хостов/секреты подключаются отдельно; здесь оно как заглушка, 1:1 с макетом.
 */
